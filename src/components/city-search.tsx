...
import { CommandEmpty, CommandGroup, CommandInput, CommandItem, CommandList, CommandDialog, CommandSeparator } from "./ui/command";
import { useState } from "react";
import { useSLocationSearch } from "@/hooks/use-weather";
...
function CitySearch() {
    ...
    const {data:locations, isLoading} = useSLocationSearch(query);
